...
//        return Jwts.parser().verifyWith(getSignKey()).build().parseSignedClaims(token).getPayload();
    ...
    private String createToken(Map<String, Object> claims, String userName) {
        return Jwts.builder()
                ...
                .setIssuedAt(new Date(System.currentTimeMillis())) // Records the token's creation time.
                .setExpiration(new Date(System.currentTimeMillis()+1000*60*2)) // Sets the token’s expiration time (current time + 2 minutes).
