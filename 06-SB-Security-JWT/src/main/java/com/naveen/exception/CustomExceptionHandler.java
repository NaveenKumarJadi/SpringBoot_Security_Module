...
public class CustomExceptionHandler {
	...
	// we can able to use own DTO class for exception messages
	// we can able to use Map for exception messages
	// we can able to use ProblemDetails class provided by SpringBoot for exception messages
